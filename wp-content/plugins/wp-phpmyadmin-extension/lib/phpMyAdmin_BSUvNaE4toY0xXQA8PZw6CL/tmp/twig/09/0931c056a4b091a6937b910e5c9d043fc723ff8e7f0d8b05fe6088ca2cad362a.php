...
($context["db"] ?? null)), "sub_tabs" => array(0 => array("link" => "db_multi_table_query.php", "text" => _gettext("Multi-table query")), 1 => array("link" => "db_qbe.php", "text" => _gettext("Query by example")))));
        // line 16
...
";
    ...
    {
        return new Twig_Source("", "database/multi_table_query/form.twig", "/opt/bitnami/apps/wordpress/htdocs/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_BSUvNaE4toY0xXQA8PZw6CL/templates/database/multi_table_query/form.twig");
    }
}
