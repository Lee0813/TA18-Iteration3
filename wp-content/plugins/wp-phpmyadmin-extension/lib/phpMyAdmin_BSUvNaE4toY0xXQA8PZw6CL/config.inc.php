...
$cfg['blowfish_secret']					= '\'f[j}ROC270RT8!Z;$*!H<9`ml9+G86O' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
$cfg['DefaultLang']						= 'en';		// 'en'
$cfg['Servers'][$i]['only_db']			= array('bitnami_wordpress') ;    //i.e. array('db1', 'db2') Show only listed databases
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_BSUvNaE4toY0xXQA8PZw6CL/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
